...
export function WhatsAppButton() {
  ...
  return (
    <motion.a
      ...
      className="fixed bottom-8 right-8 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#09090B] !text-white shadow-xl transition-transform hover:scale-110 active:scale-95 group"
    ...
    >
      ...
      {/* Pulse effect */}
      <span className="absolute inset-0 animate-ping rounded-full bg-[#09090B]/40" />
    </motion.a>
  );
}
