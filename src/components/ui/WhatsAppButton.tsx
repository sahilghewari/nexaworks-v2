...
export function WhatsAppButton() {
  ...
  return (
    <motion.a
      ...
      className="fixed bottom-8 right-8 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_20px_50px_rgba(37,211,102,0.3)] transition-transform hover:scale-110 active:scale-95 group"
