  ...
  return (
    <section className="relative isolate overflow-hidden bg-[#0D1015] py-24 sm:py-32">
      ...
      <div className="container relative z-10">
        <motion.div
          className="mx-auto max-w-3xl rounded-3xl border border-white/10 bg-gradient-to-br from-[#111827]/95 via-[#0D1015]/95 to-[#1F2937]/85 p-12 text-center shadow-[0_35px_75px_-30px_rgba(15,23,42,0.8)]"
        ...
        >
          ...
          <p className="mt-6 text-base text-[#9CA3AF] sm:text-lg">
