    ...
    <section className="bg-[#0A0D12] py-20 sm:py-24">
      <div className="container space-y-10">
        ...
        <div className="grid gap-8 lg:grid-cols-[minmax(0,0.6fr)_minmax(0,1fr)] lg:items-start lg:gap-12">
          <motion.div
            className="space-y-6 rounded-3xl border border-white/10 bg-[#0D1015] p-8 shadow-[0_26px_70px_-30px_rgba(15,23,42,0.8)]"
            initial={{ opacity: 0, y: 24 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, amount: 0.35 }}
          ...
          <motion.div
            className="space-y-4 rounded-3xl border border-white/10 bg-[#0D1015] p-8 shadow-[0_26px_70px_-30px_rgba(15,23,42,0.8)]"
            initial={{ opacity: 0, y: 26 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, amount: 0.35 }}
            transition={{ duration: 0.5, ease: "easeOut", delay: 0.1 }}
          >
            <h3 className="text-lg font-semibold text-[#CBC8BA]">The Biggest Challenge</h3>
            <p className="text-sm leading-relaxed text-[#9CA3AF]">
