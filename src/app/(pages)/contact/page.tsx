    ...
    <main className="flex flex-col bg-[#E7E2D6] text-[#0D1015]">
      <section className="relative isolate overflow-hidden bg-[#CBC8BA] py-16 sm:py-20">
        ...
        <div className="container relative z-10 space-y-4 text-center sm:max-w-4xl sm:text-left">
          <p className="text-xs uppercase tracking-[0.35em] text-[#3F3A32]">Contact</p>
      ...
      <section className="container grid gap-10 py-14 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)]">
        ...
        <div className="space-y-6 rounded-3xl border border-[#0D1015]/10 bg-[#CBC8BA] p-6 shadow-[0_24px_60px_-32px_rgba(13,16,21,0.75)]">
          <div className="space-y-2">
            <h3 className="text-xl font-semibold text-[#0D1015]">Contact details</h3>
            <p className="text-sm text-[#3F3A32]">Prefer email or a quick call? Reach us directly.</p>
          </div>

          <div className="space-y-4 text-sm text-[#3F3A32]">
            <div>
              <p className="text-xs uppercase tracking-[0.3em] text-[#3F3A32]">Email</p>
              <a className="text-[#A3542B]" href="mailto:hello@nexaworks.tech">hello@nexaworks.tech</a>
            </div>
            <div>
              <p className="text-xs uppercase tracking-[0.3em] text-[#3F3A32]">Phone</p>
              <a className="text-[#A3542B]" href="tel:+918356954152">+91-8356-954-152</a>
            </div>
            <div>
