        ...
        <div className="container max-w-5xl">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {[
              ...
              <div key={feature.title} className="rounded-2xl border border-[#0D1015]/10 bg-white/40 p-8 shadow-lg">
                <CheckCircle2 className="mb-4 h-8 w-8 text-[#A3542B]" />
                <h3 className="text-lg font-bold text-[#0D1015]">{feature.title}</h3>
                <p className="mt-2 text-sm text-[#3F3A32]">{feature.desc}</p>
              </div>
            ))}
          </div>
        </div>
